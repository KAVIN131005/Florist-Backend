...
const socials = [
  ...
  { name: 'X', href: 'https://x.com/yourprofile', color: 'hover:bg-black', bg: 'bg-neutral-800', svg: (<path d="M18.244 1.987h3.308l-7.227 8.26 8.502 11.766h-6.654l-5.214-6.817-5.973 6.817H1.678l7.73-8.82L1.254 1.987h6.826l4.713 6.231 5.451-6.231Zm-1.162 18.013h1.833L7.084 3.94H5.117l11.965 16.06Z" />) }
];
...
export default function Contact() {
  return (
    <div className="p-10 max-w-3xl mx-auto text-center">
      ...
      <p className="mt-12 text-xs text-gray-400">Replace placeholder links with your real social URLs.</p>
    </div>
  );
}
